...
smalllist = list(
 ...
 x =  cbind(CommunityList$Jaccard,CommunityList$SppRich)
)
...
setwd("")
tiff("cor1JSp.tif", res=600, compression = "lzw", height=6, width=6.5, units="in")
stan_dens(d1,"rho")+ xlim(-1,1) +xlab("Jaccard similarity vs Species richness")
dev.off()
