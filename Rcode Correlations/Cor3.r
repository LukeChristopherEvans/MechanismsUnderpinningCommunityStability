...
smalllist = list(
  ...
  x =  cbind(CommunityLis$LgMeanAb,CommunityLis$ICOV)
)
...
setwd("")
tiff("cor3LgAbICOV.tif", res=600, compression = "lzw", height=6, width=6.5, units="in")
stan_dens(d1,"rho")+ xlim(-1,1) +xlab("Log mean abundance vs Community stability")
dev.off()
